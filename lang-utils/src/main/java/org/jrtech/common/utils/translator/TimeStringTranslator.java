...
public class TimeStringTranslator implements FormatLocaleAndTimeZoneAwareStringTranslator<Date> {

	private static final long serialVersionUID = -3529378764301590017L;
	...
	public String translate(Date o, Locale locale, TimeZone timezone) {
		return dtp.getStringFromTime(o, locale, timezone);
	}
